...
ANSWER:"""
    ...
    async def generate_answer_stream(self, question: str, context: str):
        """
        Generate answer with token streaming (word-by-word).
        
        Yields each token as it's generated by Ollama for ChatGPT-style
        ...
        try:
            ...
            raise Exception("LLM streaming timed out")
        except httpx.RequestError as e:
